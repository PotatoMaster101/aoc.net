    ...
    where T : struct, INumber<T>
{
    ...
    public Area(Position<T> bottomRight, T width, T height)
        : this(bottomRight, bottomRight + new Position<T>(width - T.One, height - T.One)) { }
    ...
    public IEnumerable<Position<T>> GetRow(T row, T distance = default)
    {
        ...
        var step = distance <= T.Zero ? T.One : distance;
