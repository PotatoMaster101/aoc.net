    ...
    where T : struct, INumber<T>
{
    ...
    {
        var offset = distance <= T.Zero ? T.One : distance;
    ...
    public static Position<T> operator %(Position<T> left, Position<T> right)
    {
        return new Position<T>(MathHelper.Mod(left.X, right.X), MathHelper.Mod(left.Y, right.Y));
    }
    ...
    public static Position<T> operator %(Position<T> left, T right)
    {
        return new Position<T>(MathHelper.Mod(left.X, right), MathHelper.Mod(left.Y, right));
    }
