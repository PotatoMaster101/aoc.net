...
public class DirectionalPositionTest
{
    ...
    /// </summary>
    private class NextRangeTestData : IEnumerable<object[]>
    {
        ...
        public IEnumerator<object[]> GetEnumerator()
        {
            yield return
            [
                0, 0, 1, 0, 3, 1, new DirectionalPosition<int>[]
                {
            ...
            yield return
            [
                0, 0, 1, 0, 5, 2, new DirectionalPosition<int>[]
                {
                    new(new Position<int>(2, 0), new Position<int>(1, 0)),
            ...
            yield return
            [
                0, 0, 0, 3, 5, 1, new DirectionalPosition<int>[]
                {
            ...
            yield return
            [
                -5, 5, 1, 1, 3, 2, new DirectionalPosition<int>[]
                {
            ...
            yield return
            [
                0, 0, 0, 3, 0, 1, Array.Empty<DirectionalPosition<int>>()
            ];
            yield return
            [
