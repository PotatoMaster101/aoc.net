...
public class AreaTest
{
    ...
    [Theory]
    [ClassData(typeof(WidthHeightConstructorTestData))]
    public void WidthHeightConstructor_ReturnsCorrectValue(Position<int> bottomRight, int width, int height, Position<int> expectedTopLeft, Position<int> expectedBottomRight)
    {
        // act
        var result = new Area<int>(bottomRight, width, height);
    ...
    /// <summary>
    /// Test data for <see cref="AreaTest.WidthHeightConstructor_ReturnsCorrectValue"/>.
    /// </summary>
    private class WidthHeightConstructorTestData : IEnumerable<object[]>
    {
        IEnumerator IEnumerable.GetEnumerator() => GetEnumerator();
        public IEnumerator<object[]> GetEnumerator()
        {
            yield return [new Position<int>(), 5, 5, new Position<int>(0, 4), new Position<int>(4, 0)];
            yield return [new Position<int>(), -5, -5, new Position<int>(-6, 0), new Position<int>(0, -6)];
        }
    }
    ...
    private class GetEnumeratorTestData : IEnumerable<object[]>
    {
        ...
        public IEnumerator<object[]> GetEnumerator()
        {
            yield return [0, 0, 1, 1, new Position<int>[] { new(), new(1, 0), new(0, 1), new(1, 1) }];
            yield return
            [
                0, 0, 2, 2, new Position<int>[]
                {
                    new(), new(1, 0), new(2, 0), new(0, 1), new(1, 1), new(2, 1), new(0, 2), new(1, 2), new(2, 2)
                }
            ];
            yield return
            [
                -2, -2, 0, 0, new Position<int>[]
                {
    ...
    private class GetRowTestData : IEnumerable<object[]>
    {
        ...
        public IEnumerator<object[]> GetEnumerator()
        {
            ...
            yield return [0, 0, 2, 2, 0, 0, new Position<int>[] { new(), new(1, 0), new(2, 0) }];
            yield return [0, 0, 2, 2, 0, -1, new Position<int>[] { new(), new(1, 0), new(2, 0) }];
        }
    }
    ...
    private class GetColumnTestData : IEnumerable<object[]>
    {
        ...
        public IEnumerator<object[]> GetEnumerator()
        {
            ...
            yield return [0, 0, 2, 2, -1, 1, Array.Empty<Position<int>>()];
            yield return [0, 0, 2, 2, 3, 1, Array.Empty<Position<int>>()];
            yield return [0, 0, 2, 2, 0, 0, new Position<int>[] { new(), new(0, 1), new(0, 2) }];
            yield return [0, 0, 2, 2, 0, -1, new Position<int>[] { new(), new(0, 1), new(0, 2) }];
        }
    }
    ...
    /// </summary>
    private class WrapListTestData : IEnumerable<object[]>
    {
        IEnumerator IEnumerable.GetEnumerator() => GetEnumerator();
        public IEnumerator<object[]> GetEnumerator()
        {
            yield return
            [
                0, 0, 6, 6, new Position<int>[] { new(0, 0), new(1, 1), new(6, 6) },
                new Position<int>[] { new(0, 0), new(1, 1), new(6, 6) }
            ];
            yield return
            [
                0, 0, 6, 6, new Position<int>[] { new(-1, 0), new(0, -1), new(-1, -1) },
                new Position<int>[] { new(6, 0), new(0, 6), new(6, 6) }
            ];
            yield return
            [
                0, 0, 6, 6, new Position<int>[] { new(7, 0), new(0, 7), new(7, 7) },
                new Position<int>[] { new(0, 0), new(0, 0), new(0, 0) }
            ];
            yield return
            [
                0, 0, 6, 6, new Position<int>[] { new(-2, 8), new(9, -3) },
                new Position<int>[] { new(5, 1), new(2, 4) }
            ];
        }
    }
    ...
    /// </summary>
    private class FilterTestData : IEnumerable<object[]>
    {
        IEnumerator IEnumerable.GetEnumerator() => GetEnumerator();
        public IEnumerator<object[]> GetEnumerator()
        {
    ...
    private class GetNeighboursTestData : IEnumerable<object[]>
    {
        ...
        public IEnumerator<object[]> GetEnumerator()
        {
            ...
            [
                ...
                false, new Position<int>[] { new(0, 1), new(1, 0) }
            ];
            yield return
            [
                new Position<int>(), new Position<int>(5, 5), new Position<int>(2, 2), 1,
                new[] { Direction.Up, Direction.Down, Direction.Left, Direction.Right },
                false, new Position<int>[] { new(2, 1), new(2, 3), new(1, 2), new(3, 2) }
            ];
            yield return
            [
                new Position<int>(), new Position<int>(5, 5), new Position<int>(0, 0), 3,
                new[] { Direction.Up, Direction.Down, Direction.Left, Direction.Right },
                false, new Position<int>[] { new(0, 3), new(3, 0) }
            ];
            yield return
            [
                new Position<int>(), new Position<int>(5, 5), new Position<int>(2, 2), 2,
                new[] { Direction.Up, Direction.Up, Direction.TopLeft },
                false, new Position<int>[] { new(2, 0), new(2, 0), new(0, 4) }
            ];
            yield return
            [
                ...
                false, new Position<int>[] { new(4, 4), new(4, 4) }
            ];
            yield return
            [
                new Position<int>(), new Position<int>(5, 5), new Position<int>(-1, -2), 3,
                new[] { Direction.Up, Direction.TopRight },
                false, new Position<int>[] { new(2, 1) }
            ];
            yield return
            [
                new Position<int>(), new Position<int>(5, 5), new Position<int>(-10, -9), 3,
                new[] { Direction.Up, Direction.TopRight }, false, Array.Empty<Position<int>>()
            ];
            yield return
            [
                new Position<int>(), new Position<int>(5, 5), new Position<int>(2, 2), 1,
                Array.Empty<Direction>(), false, Array.Empty<Position<int>>()
            ];
            yield return
            [
                new Position<int>(), new Position<int>(5, 5), new Position<int>(2, 2), 1,
                null!, false, new Position<int>[] { new(2, 1), new(2, 3), new(1, 2), new(3, 2) }
            ];
            yield return
            [
                new Position<int>(), new Position<int>(5, 5), new Position<int>(0, 0), 1,
                new[] { Direction.Up, Direction.Down, Direction.Left, Direction.Right },
                true, new Position<int>[] { new(0, 5), new(0, 1), new(5, 0), new(1, 0) }
            ];
        }
    }
}
