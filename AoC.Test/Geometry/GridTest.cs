...
public class GridTest
{
    ...
    public void Constructor_ReturnsCorrectValue(int[] data, int width, int defaultValue, int[] expectedData)
    {
        // act
    ...
    private class BreadthFirstSearchTestData : IEnumerable<object[]>
    {
        ...
        public IEnumerator<object[]> GetEnumerator()
        {
            ...
            [
                ...
                new GridEntry<int>[] { new(new Position<int>(1, 0), 2), new(new Position<int>(1, 1), 5), new(new Position<int>(1, 2), 8) }
            ];
            yield return
            [
