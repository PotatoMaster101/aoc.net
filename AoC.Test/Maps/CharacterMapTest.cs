...
public class CharacterMapTest
{
    ...
    /// </summary>
    private class IsWallTestData : TheoryData<Grid<char>, Position<int>, bool>
    {
        public IsWallTestData()
        {
            Add(new Grid<char>(['S', '.', '#', '.', '#', '.', '#', '.', 'E'], 3), new Position<int>(0, 0), false);
            Add(new Grid<char>(['S', '.', '#', '.', '#', '.', '#', '.', 'E'], 3), new Position<int>(1, 0), false);
            Add(new Grid<char>(['S', '.', '#', '.', '#', '.', '#', '.', 'E'], 3), new Position<int>(2, 0), true);
            Add(new Grid<char>(['S', '.', '#', '.', '#', '.', '#', '.', 'E'], 3), new Position<int>(0, 1), false);
            Add(new Grid<char>(['S', '.', '#', '.', '#', '.', '#', '.', 'E'], 3), new Position<int>(1, 1), true);
            Add(new Grid<char>(['S', '.', '#', '.', '#', '.', '#', '.', 'E'], 3), new Position<int>(2, 1), false);
            Add(new Grid<char>(['S', '.', '#', '.', '#', '.', '#', '.', 'E'], 3), new Position<int>(0, 2), true);
            Add(new Grid<char>(['S', '.', '#', '.', '#', '.', '#', '.', 'E'], 3), new Position<int>(1, 2), false);
            Add(new Grid<char>(['S', '.', '#', '.', '#', '.', '#', '.', 'E'], 3), new Position<int>(2, 2), false);
        }
    }
    ...
    /// </summary>
    private class IsPathTestData : TheoryData<Grid<char>, Position<int>, bool>
    {
        public IsPathTestData()
        {
            Add(new Grid<char>(['S', '.', '#', '.', '#', '.', '#', '.', 'E'], 3), new Position<int>(0, 0), true);
            Add(new Grid<char>(['S', '.', '#', '.', '#', '.', '#', '.', 'E'], 3), new Position<int>(1, 0), true);
            Add(new Grid<char>(['S', '.', '#', '.', '#', '.', '#', '.', 'E'], 3), new Position<int>(2, 0), false);
            Add(new Grid<char>(['S', '.', '#', '.', '#', '.', '#', '.', 'E'], 3), new Position<int>(0, 1), true);
            Add(new Grid<char>(['S', '.', '#', '.', '#', '.', '#', '.', 'E'], 3), new Position<int>(1, 1), false);
            Add(new Grid<char>(['S', '.', '#', '.', '#', '.', '#', '.', 'E'], 3), new Position<int>(2, 1), true);
            Add(new Grid<char>(['S', '.', '#', '.', '#', '.', '#', '.', 'E'], 3), new Position<int>(0, 2), false);
            Add(new Grid<char>(['S', '.', '#', '.', '#', '.', '#', '.', 'E'], 3), new Position<int>(1, 2), true);
            Add(new Grid<char>(['S', '.', '#', '.', '#', '.', '#', '.', 'E'], 3), new Position<int>(2, 2), true);
        }
    }
}
